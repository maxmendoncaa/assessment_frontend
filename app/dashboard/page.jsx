...
//         const modulesResponse = await axiosInstance.get('api/v1/modules', { withCredentials: true });
...
//   const canManageModules = ['MODULE_ASSESSMENT_LEAD', 'MODERATOR', 'PROGRAMME_DIRECTOR'].includes(userRole);
